...
class LoginWindow:
    ...
    def add_frame(self):
        ...
        self.button1 = Button(self.frame, text="Register", font='Courier 15 bold',
                             command=self.login)
        self.button1.place(x=170, y=y+290)

        ## TODO: command to go back
        self.button2 = Button(self.frame, text="Back", font='Courier 15 bold',)
        self.button2.place(x=170, y=y+290)
