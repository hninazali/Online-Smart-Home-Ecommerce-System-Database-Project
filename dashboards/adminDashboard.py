...
import os
import sys
# import lib.adminProduct as adminProduct
# import lib.adminRequest as adminRequest
# import lib.adminProfile as adminProfile
...
class AdminDashboard(tk.Frame):
    def __init__(self, username):
        ...
        profile_btn = tk.Button(self.navBar,image=profile_icon, bd=0,background='#4267b2',activebackground='#4267b2',command=lambda:self.win.frameSwitcher(adminProfile.AdminProfilePage, self.username))
